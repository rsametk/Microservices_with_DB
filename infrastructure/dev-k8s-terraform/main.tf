...
resource "aws_instance" "kube-master" {
    ...
    vpc_security_group_ids = [aws_security_group.petclinic-kube-master-sg.id, aws_security_group.
petclinic-mutual-sg.id]
    key_name = "clarus"
    subnet_id = "subnet-030f2c2c321e6fdf7"  # select own subnet_id of us-east-1a
...
resource "aws_instance" "worker-1" {
    ami = "ami-053b0d53c279acc90"
    instance_type = "t3a.medium"
    vpc_security_group_ids = [aws_security_group.petclinic-kube-worker-sg.id, aws_security_group.
petclinic-mutual-sg.id]
    key_name = "clarus"
    subnet_id = "subnet-030f2c2c321e6fdf7"  # select own subnet_id of us-east-1a
    availability_zone = "us-east-1a"
